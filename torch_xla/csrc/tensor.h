...
class XLATensor;
using XLATensorPtrPtr = c10::intrusive_ptr<XLATensorPtr>;


class XLATensorPtr : public c10::intrusive_ptr_target {
 ...
 public:
  ...
  XLATensorPtr alias() const { return c10::make_intrusive<XLATensor>(data_ptr()); }
  ...
  static std::string DumpHloComputation(const std::vector<XLATensorPtr>& tensors);
  ...
  static void sgd_optimizer_step_(const XLATensorPtr& found_inf, XLATensorPtr& step,
  ...
  static void adam_optimizer_step_(const XLATensorPtr& found_inf, XLATensorPtr& step,
  ...
  static XLATensorPtr adaptive_max_pool2d_backward(const XLATensorPtr& grad_output,
                                                const XLATensorPtr& input);

  static XLATensorPtr adaptive_avg_pool3d(const XLATensorPtr& input,
                                       std::vector<int64_t> output_size);

  static XLATensorPtr adaptive_avg_pool3d_backward(const XLATensorPtr& grad_output,
                                                const XLATensorPtr& input);

  static XLATensorPtr _adaptive_avg_pool2d(const XLATensorPtr& input,
                                        std::vector<int64_t> output_size);

  static XLATensorPtr _adaptive_avg_pool2d_backward(const XLATensorPtr& grad_output,
                                                 const XLATensorPtr& input);
  ...
  static XLATensorPtr add(
      const XLATensorPtr& input, const XLATensorPtr& other, const at::Scalar& alpha,
      c10::optional<at::ScalarType> logical_element_type = c10::nullopt);
  static XLATensorPtr add(
      const XLATensorPtr& input, const at::Scalar& other, const at::Scalar& alpha,
      c10::optional<at::ScalarType> logical_element_type = c10::nullopt);

  static XLATensorPtr addcdiv(const XLATensorPtr& input, const at::Scalar& value,
                           const XLATensorPtr& tensor1, const XLATensorPtr& tensor2);
  static void addcdiv_(XLATensorPtr& input, const at::Scalar& value,
                       const XLATensorPtr& tensor1, const XLATensorPtr& tensor2);

  static XLATensorPtr addcmul(const XLATensorPtr& input, const at::Scalar& value,
                           const XLATensorPtr& tensor1, const XLATensorPtr& tensor2);

  static XLATensorPtr addmm(const XLATensorPtr& input, const XLATensorPtr& weight,
                         const XLATensorPtr& bias);

  static XLATensorPtr all(const XLATensorPtr& input, std::vector<int64_t> dimensions,
                       bool keep_reduced_dimensions);

  static XLATensorPtr amax(const XLATensorPtr& input, std::vector<int64_t> dimensions,
                        bool keep_reduced_dimensions);

  static XLATensorPtr amin(const XLATensorPtr& input, std::vector<int64_t> dimensions,
                        bool keep_reduced_dimensions);

  static XLATensorPtr any(const XLATensorPtr& input, std::vector<int64_t> dimensions,
                       bool keep_reduced_dimensions);
  ...
  static XLATensorPtr argmax(const XLATensorPtr& input, int64_t dim, bool keepdim);
  static XLATensorPtr argmax(const XLATensorPtr& input);

  static XLATensorPtr argmin(const XLATensorPtr& input, int64_t dim, bool keepdim);
  ...
  static XLATensorPtr as_strided(const XLATensorPtr& input, std::vector<int64_t> size,
  ...
  static XLATensorPtr avg_pool_nd_backward(const XLATensorPtr& out_backprop,
                                        const XLATensorPtr& input,
                                        int64_t spatial_dim_count,
                                        std::vector<int64_t> kernel_size,
                                        std::vector<int64_t> stride,
  ...
  static XLATensorPtr baddbmm(const XLATensorPtr& input, const XLATensorPtr& batch1,
  ...
  static XLATensorPtr binary_cross_entropy_backward(const XLATensorPtr& grad_output,
                                                 const XLATensorPtr& input,
                                                 const XLATensorPtr& target,
                                                 const XLATensorPtr& weight,
                                                 int64_t reduction);

  static XLATensorPtr bitwise_and(const XLATensorPtr& input, const at::Scalar& other);

  static XLATensorPtr bitwise_and(const XLATensorPtr& input, const XLATensorPtr& other);

  static XLATensorPtr bitwise_not(const XLATensorPtr& input);

  static XLATensorPtr bitwise_or(const XLATensorPtr& input, const at::Scalar& other);

  static XLATensorPtr bitwise_or(const XLATensorPtr& input, const XLATensorPtr& other);

  static XLATensorPtr bitwise_xor(const XLATensorPtr& input, const at::Scalar& other);

  static XLATensorPtr bitwise_xor(const XLATensorPtr& input, const XLATensorPtr& other);
  ...
  // multiplication.
  static XLATensorPtr bmm(const XLATensorPtr& batch1, const XLATensorPtr& batch2);
  ...
  static XLATensorPtr convolution_overrideable(
      const XLATensorPtr& input, const XLATensorPtr& weight, const XLATensorPtr& bias,
  ...
  // with the size 3.
  static XLATensorPtr cross(const XLATensorPtr& input, const XLATensorPtr& other,
  ...
  static XLATensorPtr erf(const XLATensorPtr& input);

  static XLATensorPtr erfc(const XLATensorPtr& input);

  static XLATensorPtr erfinv(const XLATensorPtr& input);

  static XLATensorPtr exp(const XLATensorPtr& input);

  static XLATensorPtr expand(const XLATensorPtr& input, std::vector<int64_t> size);
  ...
  static XLATensorPtr flip(const XLATensorPtr& input, absl::Span<const int64_t> dims);
  ...
  static XLATensorPtr gelu_backward(const XLATensorPtr& grad, const XLATensorPtr& input,
                                 const c10::string_view approximate);
  ...
  static void index_fill_(XLATensorPtr& input, int64_t dim, const XLATensorPtr& index,
  ...
  static void index_put_(XLATensorPtr& input, const XLATensorPtr& canonical_base,
  ...
  static std::tuple<XLATensorPtr, XLATensorPtr> kthvalue(const XLATensorPtr& input,
  ...
  static XLATensorPtr hardshrink(const XLATensorPtr& input, const at::Scalar& lambda);
  ...
  static XLATensorPtr leaky_relu(const XLATensorPtr& input, double negative_slope);
  ...
  static XLATensorPtr log_base(const XLATensorPtr& input, torch::lazy::OpKind op,
                            double base);
  ...
  static XLATensorPtr logical_xor(const XLATensorPtr& input, const XLATensorPtr& other);

  static XLATensorPtr logical_and(const XLATensorPtr& input, const XLATensorPtr& other);

  static XLATensorPtr logical_or(const XLATensorPtr& input, const XLATensorPtr& other);

  static XLATensorPtr logsumexp(const XLATensorPtr& input,
                             std::vector<int64_t> dimensions,
                             bool keep_reduced_dimensions);

  static XLATensorPtr xlogy(const XLATensorPtr& input, const XLATensorPtr& other);
  ...
  static XLATensorPtr masked_select(const XLATensorPtr& input, const XLATensorPtr& mask);

  static XLATensorPtr matmul(const XLATensorPtr& input, const XLATensorPtr& other);
  ...
  static XLATensorPtr max_unpool(const XLATensorPtr& input, const XLATensorPtr& indices,
                              std::vector<int64_t> output_size);
  ...
  static XLATensorPtr mean(const XLATensorPtr& input, std::vector<int64_t> dimensions,
                        bool keep_reduced_dimensions,
                        c10::optional<at::ScalarType> dtype);
  ...
  static XLATensorPtr mse_loss(const XLATensorPtr& input, const XLATensorPtr& target,
                            int64_t reduction);
  ...
  static XLATensorPtr nan_to_num(const XLATensorPtr& input, const at::Scalar& nan,
                              const at::Scalar& posinf,
                              const at::Scalar& neginf);

  // Returns a new tensor that is a narrowed view of the input in the given
  // dimension.
  static XLATensorPtr narrow(const XLATensorPtr& input, int64_t dim, int64_t start,
                          int64_t length);
  ...
  static std::tuple<XLATensorPtr, XLATensorPtr, XLATensorPtr> native_batch_norm(
      const XLATensorPtr& input, const XLATensorPtr& weight, const XLATensorPtr& bias,
      XLATensorPtr& running_mean, XLATensorPtr& running_var, bool training,
      double momentum, double eps);

  // Returns the input, weight and bias gradients.
  static std::tuple<XLATensorPtr, XLATensorPtr, XLATensorPtr> native_batch_norm_backward(
  ...
  static XLATensorPtr nll_loss(const XLATensorPtr& input, const XLATensorPtr& target,
                            const XLATensorPtr& weight, int64_t reduction,
                            int ignore_index);

  static XLATensorPtr nll_loss2d(const XLATensorPtr& input, const XLATensorPtr& target,
                              const XLATensorPtr& weight, int64_t reduction,
                              int ignore_index);
  ...
  static std::pair<XLATensorPtr, XLATensorPtr> nms(const XLATensorPtr& boxes,
  ...
  static XLATensorPtr pow(const XLATensorPtr& input, const at::Scalar& exponent);
  static XLATensorPtr pow(const XLATensorPtr& input, const XLATensorPtr& exponent);
  static XLATensorPtr pow(const at::Scalar& input, const XLATensorPtr& exponent);

  static XLATensorPtr prelu(const XLATensorPtr& input, const XLATensorPtr& weight);

  static XLATensorPtr prod(const XLATensorPtr& input, std::vector<int64_t> dimensions,
                        bool keep_reduced_dimensions,
                        c10::optional<at::ScalarType> dtype);
  ...
  static std::tuple<XLATensorPtr, XLATensorPtr> qr(const XLATensorPtr& input, bool some);

  static void random_(XLATensorPtr& input, int64_t from, int64_t to);

  static XLATensorPtr randperm(int64_t n, const torch::lazy::BackendDevice& device,
                            at::ScalarType scalar_type);
  ...
  static XLATensorPtr remainder(const XLATensorPtr& input, const XLATensorPtr& other);
  static XLATensorPtr remainder(const XLATensorPtr& input, const at::Scalar& other);

  // Repeats the input tensor along each dimension by the given number of
  // repeats.
  static XLATensorPtr repeat(const XLATensorPtr& input, std::vector<int64_t> repeats);

  static XLATensorPtr replication_pad1d(const XLATensorPtr& input,
                                     std::vector<int64_t> padding);
  static XLATensorPtr replication_pad1d_backward(const XLATensorPtr& grad_output,
                                              const XLATensorPtr& input,
                                              std::vector<int64_t> padding);

  static XLATensorPtr replication_pad2d(const XLATensorPtr& input,
                                     std::vector<int64_t> padding);
  static XLATensorPtr replication_pad2d_backward(const XLATensorPtr& grad_output,
                                              const XLATensorPtr& input,
                                              std::vector<int64_t> padding);
  ...
  static XLATensorPtr rrelu_with_noise(const XLATensorPtr& input, XLATensorPtr& noise,
  ...
  static XLATensorPtr select(const XLATensorPtr& input, int64_t dim, int64_t index);
  ...
  static XLATensorPtr silu_backward(XLATensorPtr& grad_output, XLATensorPtr& input);
  static XLATensorPtr sigmoid(const XLATensorPtr& input);
  static XLATensorPtr sigmoid_backward(const XLATensorPtr& grad_output,
                                    const XLATensorPtr& output);

  static XLATensorPtr slice(const XLATensorPtr& input, int64_t dim, int64_t start,
                         int64_t end, int64_t step);

  static std::tuple<XLATensorPtr, XLATensorPtr> slogdet(const XLATensorPtr& input);
  ...
  static XLATensorPtr softplus(const XLATensorPtr& input, const at::Scalar& beta,
  ...
  static XLATensorPtr softshrink(const XLATensorPtr& input, const at::Scalar& lambda);
  ...
  static XLATensorPtr stack(absl::Span<const XLATensorPtr> tensors, int64_t dim);

  static XLATensorPtr std(const XLATensorPtr& input, std::vector<int64_t> dimensions,
  ...
  static XLATensorPtr sum(const XLATensorPtr& input, std::vector<int64_t> dimensions,
                       bool keep_reduced_dimensions,
                       c10::optional<at::ScalarType> dtype);

  static std::tuple<XLATensorPtr, XLATensorPtr, XLATensorPtr> svd(const XLATensorPtr& input,
                                                         bool some,
                                                         bool compute_uv);

  static std::tuple<XLATensorPtr, XLATensorPtr> symeig(const XLATensorPtr& input,
                                                 bool eigenvectors, bool upper);

  static XLATensorPtr take(const XLATensorPtr& input, const XLATensorPtr& index);
  ...
  static std::tuple<XLATensorPtr, XLATensorPtr> triangular_solve(
      const XLATensorPtr& rhs, const XLATensorPtr& lhs, bool left_side, bool upper,
  ...
  // removed.
  static std::vector<XLATensorPtr> unbind(const XLATensorPtr& input, int64_t dim);
  ...
  static XLATensorPtr upsample_nearest2d_backward(const XLATensorPtr& grad_output,
                                               std::vector<int64_t> output_size,
                                               std::vector<int64_t> input_size);

  static XLATensorPtr var(const XLATensorPtr& input, std::vector<int64_t> dimensions,
                       int64_t correction, bool keep_reduced_dimensions);
  ...
  static XLATensorPtr where(const XLATensorPtr& condition, const XLATensorPtr& input,
                         const XLATensorPtr& other);
